...
const tranTable = new Map<string, { EN: string, CN: string }>()
    ...
    .set('ignoreOnDupName', { EN: "Skip Uploaded Files", CN: "忽略重复上传" })
    ...
    .set('compressed', { EN: "Zipped", CN: "是否 Zip" })
    ...
    .set('dir', { EN: 'Directory', CN: '目录' })
    .set('parentFileName', { EN: 'In Directory', CN: '所属目录' })
    .set('moveIntoDir', { EN: 'Move Into Directory', CN: '移到目录' })
